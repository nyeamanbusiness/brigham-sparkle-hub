...
export default function Gallery() {
  ...
  const purpleText = "#6A1B9A"; // pulled from your purple screenshot
      ...
      <section className="gradient-hero text-primary-foreground py-20">
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Before & After Gallery</h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto">
              See the incredible transformations we've achieved for our clients. From heavily soiled interiors to
              oxidized paint, we restore vehicles to showroom condition.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                <div className="grid grid-cols-2">
                  <div className="relative aspect-square">
                    <div
                      ...
                      style={{ backgroundColor: "white", color: purpleText }}
                    >
                      BEFORE
                    </div>
