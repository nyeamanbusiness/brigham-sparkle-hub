...
export default function AutoDetailingExterior() {
  ...
  const benefits = ["Professional hand wash with pH-neutral foam", "Chemical decontamination (removes iron fallout)", "Clay bar treatment for smooth paint", "Multi-stage paint polishing", "Premium wax or sealant application", "Tire & wheel deep cleaning", "Trim restoration & dressing", "Window cleaning (inside & out)"];
  const packages = [{
    name: "Clay & Seal",
    duration: "2 hrs",
    prices: [{
  ...
  return <>
      <Meta title="Exterior Auto Detailing in Brigham City, UT | Wash, Clay & Wax" description="Professional exterior auto detailing in Brigham City, Utah. Hand wash, clay bar, wax, and paint protection to restore your car's shine." canonical={url} />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            duration: 0.6
              ...
              <img src="https://dreeuacqovhldjhlynio.supabase.co/storage/v1/object/public/imagebucket/sports-car-exterior-detailing.webp" alt="Professional truck exterior detailing showing clean paint and shine" className="w-full h-auto hover-scale" />
            </motion.div>
            <motion.div initial={{
            opacity: 0,
            y: 30
            ...
            duration: 0.6
              ...
              <img src="https://dreeuacqovhldjhlynio.supabase.co/storage/v1/object/public/imagebucket/sparkle-auto-detailing-exterior-detail-suv.webp" alt="Sparkle Auto Detailing SUV exterior detail showing pristine finish" className="w-full h-auto hover-scale" />
            </motion.div>
            <motion.div initial={{
            opacity: 0,
            y: 30
            ...
            delay: 0.2
              ...
              <img src="https://dreeuacqovhldjhlynio.supabase.co/storage/v1/object/public/imagebucket/exterior-detailing-job.webp" alt="Professional exterior detailing job showcasing clean vehicle finish" className="w-full h-auto hover-scale" />
            </motion.div>
            <motion.div initial={{
            opacity: 0,
            y: 30
            ...
            delay: 0.2
              ...
              <img src="https://dreeuacqovhldjhlynio.supabase.co/storage/v1/object/public/imagebucket/truck-exterior-detailing.webp" alt="Sports car exterior detailing showing professional results and shine" className="w-full h-auto hover-scale" />
            </motion.div>
          </div>
        </div>
      </section>
