...
export default function CeramicCoating() {
  ...
  const benefits = [
    {
      ...
      description:
        "Ceramic coating forms a durable, protective layer over your vehicle's paint, lasting 2-5 years or more depending on the product and maintenance.",
    },
    {
      icon: <Sparkles className="h-8 w-8" />,
      title: "Superior Gloss and Shine",
      description:
        "It enhances your car's appearance with a deep, mirror-like gloss that keeps your vehicle looking freshly detailed every day.",
    },
    {
      icon: <Sun className="h-8 w-8" />,
      title: "UV & Oxidation Resistance",
      description:
        "Ceramic coating protects against harmful UV rays, preventing paint from fading, dulling, and oxidizing over time.",
    },
    {
      icon: <Droplet className="h-8 w-8" />,
      title: "Hydrophobic Properties",
      description:
        "Water, dirt, and grime bead up and roll off easily, making your car easier to clean and helping it stay cleaner for longer.",
    },
  ];
  ...
  const package_info = {
    ...
    description:
      "Give your vehicle the ultimate protection and showroom shine with our professional ceramic coating service.",
  };

  // Shared classes for consistent visual rhythm
  const imageCardClass = "rounded-lg overflow-hidden shadow-lg hover-lift h-[380px] sm:h-[420px] md:h-[500px]";
  const imageClass = "w-full h-full object-cover object-center";
    ...
    <>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          {/* items-stretch + h-full on cards => equal height */}
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                className="bg-card p-6 rounded-lg shadow-md hover-lift h-full flex flex-col"
              >
