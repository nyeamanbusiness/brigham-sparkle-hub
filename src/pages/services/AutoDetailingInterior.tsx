...
export default function AutoDetailingInterior() {
  ...
  return <>
      <Meta title="Interior Auto Detailing in Brigham City, UT | Deep Clean & Sanitize" description="Professional interior detailing in Brigham City. Deep clean, odor removal, shampoo, and protection for all vehicle interiors. Book today!" canonical={url} />
        ...
        <div className="container mx-auto px-4">
          ...
          duration: 0.6
            ...
            <div className="mb-10">
              ...
              <p className="text-muted-foreground mb-4">Perfect for regular maintenance and a fresh interior.</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            duration: 0.6
              ...
              <img src="https://dreeuacqovhldjhlynio.supabase.co/storage/v1/object/public/imagebucket/truck-interior-detailing.webp" alt="Professional truck interior detailing showing deep cleaned seats and surfaces" className="w-full h-auto hover-scale" />
            </motion.div>
            <motion.div initial={{
            opacity: 0,
            y: 30
            ...
            duration: 0.6
              ...
              <img src="https://dreeuacqovhldjhlynio.supabase.co/storage/v1/object/public/imagebucket/truck-seat-interior-detail.webp" alt="Close-up of pristine truck seat after professional interior detailing" className="w-full h-auto hover-scale" />
            </motion.div>
            <motion.div initial={{
            opacity: 0,
            y: 30
            ...
            delay: 0.2
              ...
              <img src="https://dreeuacqovhldjhlynio.supabase.co/storage/v1/object/public/imagebucket/suv-interior-detailing.webp" alt="Professional SUV interior detailing showcasing clean interior cabin" className="w-full h-auto hover-scale" />
            </motion.div>
            <motion.div initial={{
            opacity: 0,
            y: 30
            ...
            delay: 0.2
              ...
              <img src="https://dreeuacqovhldjhlynio.supabase.co/storage/v1/object/public/imagebucket/sports-car-interior-detailing.webp" alt="Sparkle Auto Detailing corvette interior detail work showing professional results" className="w-full h-auto hover-scale" />
            </motion.div>
          </div>
        </div>
      </section>
